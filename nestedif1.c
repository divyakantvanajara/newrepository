// write a program to findout which month has lowest number of days outof given three month
#include<stdio.h>
void main()
{
    ...
    {
        printf(" month 1 is invalid month");
    }
    ...
    {
        printf(" month 3 is invalid month");
    }
